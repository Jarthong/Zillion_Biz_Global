...
if __name__ == '__main__':
    # a = WsCustomClient(url='wss://kline.zbg.com/websocket', market_id_param='336', market_name_param='zt_usdt')

    print('\n' + 'test_websocket_data:')
    market_id = '336'
    # if not market_id:
    #     raise CustomError('市场不存在')
    ws = WsCustomClient(url='wss://kline.zbg.com/websocket', market_id_param='336', market_name_param='zt_usdt')
    ws.connect()
    time.sleep(5)
